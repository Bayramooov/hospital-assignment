...
use hospital;
delimiter //
create procedure blood_groups_save
(
...
use hospital;
delimiter //
create procedure blood_groups_load
(
  in i_blood_group_id int(10)
)
begin
...
use hospital;
delimiter //
create procedure blood_drawings_save
(
  i_drawing_id                      int(10),
  i_procedure_id                    int(10),
...
use hospital;
delimiter //
create procedure blood_drawings_load
(
...
use hospital;
delimiter //
create procedure blood_donations_save
(
...
use hospital;
delimiter //
create procedure blood_donations_load
(
